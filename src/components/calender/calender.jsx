                                    ...
                                    <div id="calendar" className="fc fc-ltr">
                                        <table className="fc-header" style={{ width: "100%" }}>
                                            <tr>
                                                ...
                                                <td className="fc-header-center">
                                                    <span className="fc-button fc-button-agendaDay fc-state-default fc-corner-left" unselectable="on">day</span>
                                                    <span className="fc-button fc-button-agendaWeek fc-state-default" unselectable="on">week</span>
                                                    <span className="fc-button fc-button-month fc-state-default fc-corner-right fc-state-active" unselectable="on">month</span>
                                                </td>
                                                <td className="fc-header-right">
                                                    <span className="fc-button fc-button-prev fc-state-default fc-corner-left" unselectable="on">
                                                        <span className="fc-text-arrow">‹</span>
                                                    </span>
                                                    <span className="fc-button fc-button-next fc-state-default fc-corner-right" unselectable="on">
                                                        <span className="fc-text-arrow">›</span>
                                                    </span>
                                                    <span className="fc-header-space"></span>
                                                    <span className="fc-button fc-button-today fc-state-default fc-corner-left fc-corner-right fc-state-disabled" unselectable="on">today</span>
                                                </td>
                                            </tr>
                                        </table>
                                        <div className="fc-content" style={{ position: "relative" }}>
                                            <div className="fc-view fc-view-month fc-grid" style={{ position: "relative" }} unselectable="on">
                                                <div className="fc-event-container" style={{ position: "absolute", zIndex: 8, top: 0, left: 0 }}>
                                                    <div className="fc-event fc-event-hori fc-event-draggable fc-event-start fc-event-end" style={{ position: "absolute", left: 3, width: 146, top: 90 }}>
                                                        <div className="fc-event-inner">
                                                            <span className="fc-event-title">All Day Event</span>
                                                        </div>
                                                        <div className="ui-resizable-handle ui-resizable-e">&nbsp;&nbsp;&nbsp;</div>
                                                    </div>
                                                    <div className="fc-event fc-event-hori fc-event-draggable fc-event-start fc-event-end info" style={{ position: "absolute", left: 162, width: 146, top: 219 }}>
                                                        <div className="fc-event-inner">
                                                            <span className="fc-event-time">4p</span>
                                                            <span className="fc-event-title">Repeating Event</span>
                                                        </div>
                                                        <div className="ui-resizable-handle ui-resizable-e">&nbsp;&nbsp;&nbsp;</div>
                                                    </div>
                                                    <div className="fc-event fc-event-hori fc-event-draggable fc-event-start fc-event-end info" style={{ position: "absolute", left: 162, width: 146, top: 347 }}>
                                                        <div className="fc-event-inner">
                                                            <span className="fc-event-time">4p</span>
                                                            <span className="fc-event-title">Repeating Event</span>
                                                        </div>
                                                    ...
                                                    <div className="fc-event fc-event-hori fc-event-draggable fc-event-start fc-event-end important" style={{ position: "absolute", left: 639, width: 146, top: 219 }}>
                                                        <div className="fc-event-inner">
                                                            <span className="fc-event-time">10:30a</span>
                                                            <span className="fc-event-title">Meeting</span>
                                                        </div>
                                                        <div className="ui-resizable-handle ui-resizable-e">&nbsp;&nbsp;&nbsp;</div>
                                                    </div>
                                                    <div className="fc-event fc-event-hori fc-event-draggable fc-event-start fc-event-end important" style={{ position: "absolute", left: 639, width: 146, top: 247 }}>
                                                        <div className="fc-event-inner">
                                                            <span className="fc-event-time">12p</span>
                                                            <span className="fc-event-title">Lunch</span>
                                                        </div>
                                                        <div className="ui-resizable-handle ui-resizable-e">&nbsp;&nbsp;&nbsp;</div>
                                                    </div>
                                                    <div className="fc-event fc-event-hori fc-event-draggable fc-event-start fc-event-end" style={{ position: "absolute", left: 798, width: 146, top: 219 }}>
                                                        <div className="fc-event-inner">
                                                            <span className="fc-event-time">7p</span>
                                                            <span className="fc-event-title">Birthday Party</span>
                                                        </div>
                                                        <div className="ui-resizable-handle ui-resizable-e">&nbsp;&nbsp;&nbsp;</div>
                                                    </div>
                                                    <a href="http://google.com/" className="fc-event fc-event-hori fc-event-draggable fc-event-start success" style={{ position: "absolute", left: 957, width: 8, top: 475 }}>
                                                        <div className="fc-event-inner">
                                                            <span className="fc-event-title">Click for Google</span>
                                                        </div>
                                                    </a>
                                                    <a href="http://google.com/" className="fc-event fc-event-hori fc-event-draggable fc-event-end success" style={{ position: "absolute", left: 0, width: 149, top: 603 }}>
                                                        <div className="fc-event-inner">
                                                            <span className="fc-event-title">Click for Google</span>
                                                        </div>
                                                        <div className="ui-resizable-handle ui-resizable-e">&nbsp;&nbsp;&nbsp;</div>
                                                ...
                                                <table className="fc-border-separate" style={{ width: "100%" }} cellSpacing="0">
                                                    <thead>
                                                        <tr className="fc-first fc-last">
                                                            <th className="fc-day-header fc-mon fc-widget-header fc-first" style={{ width: 159 }}>Mon</th>
                                                            <th className="fc-day-header fc-tue fc-widget-header" style={{ width: 159 }}>Tue</th>
                                                            <th className="fc-day-header fc-wed fc-widget-header" style={{ width: 159 }}>Wed</th>
                                                            <th className="fc-day-header fc-thu fc-widget-header" style={{ width: 159 }}>Thu</th>
                                                            <th className="fc-day-header fc-fri fc-widget-header" style={{ width: 159 }}>Fri</th>
                                                            <th className="fc-day-header fc-sat fc-widget-header" style={{ width: 159 }}>Sat</th>
                                                            <th className="fc-day-header fc-sun fc-widget-header fc-last">Sun</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <tr className="fc-week fc-first">
                                                            <td className="fc-day fc-mon fc-widget-content fc-past fc-first" data-date="2024-07-01">
                                                                <div style={{ minHeight: 128 }}>
                                                                    <div className="fc-day-number">1</div>
                                                                    <div className="fc-day-content">
                                                                        <div style={{ position: "relative", height: 28 }}>&nbsp;</div>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td className="fc-day fc-tue fc-widget-content fc-past" data-date="2024-07-02">
                                                                <div>
                                                            ...
                                                            <td className="fc-day fc-wed fc-widget-content fc-past" data-date="2024-07-03">
                                                                <div>
                                                            ...
                                                            <td className="fc-day fc-thu fc-widget-content fc-past" data-date="2024-07-04">
                                                                <div>
                                                            ...
                                                            <td className="fc-day fc-fri fc-widget-content fc-past" data-date="2024-07-05">
                                                                <div>
                                                            ...
                                                            <td className="fc-day fc-sat fc-widget-content fc-past" data-date="2024-07-06">
                                                                <div>
                                                            ...
                                                            <td className="fc-day fc-sun fc-widget-content fc-past fc-last" data-date="2024-07-07">
                                                                <div>
                                                        ...
                                                        <tr className="fc-week">
                                                            <td className="fc-day fc-mon fc-widget-content fc-past fc-first" data-date="2024-07-08">
                                                                <div>
                                                            ...
                                                            <td className="fc-day fc-tue fc-widget-content fc-past" data-date="2024-07-09">
                                                                <div>
                                                            ...
                                                            <td className="fc-day fc-wed fc-widget-content fc-past" data-date="2024-07-10">
                                                                <div>
                                                            ...
                                                            <td className="fc-day fc-thu fc-widget-content fc-past" data-date="2024-07-11">
                                                                <div>
                                                            ...
                                                            <td className="fc-day fc-fri fc-widget-content fc-past" data-date="2024-07-12">
                                                                <div>
                                                            ...
                                                            <td className="fc-day fc-sat fc-widget-content fc-past" data-date="2024-07-13">
                                                                <div>
                                                            ...
                                                            <td className="fc-day fc-sun fc-widget-content fc-past fc-last" data-date="2024-07-14">
                                                                <div>
                                                        ...
                                                        <tr className="fc-week">
                                                            <td className="fc-day fc-mon fc-widget-content fc-past fc-first" data-date="2024-07-15">
                                                                <div>
                                                            ...
                                                            <td className="fc-day fc-tue fc-widget-content fc-past" data-date="2024-07-16">
                                                                <div>
                                                            ...
                                                            <td className="fc-day fc-wed fc-widget-content fc-past" data-date="2024-07-17">
                                                                <div>
                                                            ...
                                                            <td className="fc-day fc-thu fc-widget-content fc-past" data-date="2024-07-18">
                                                                <div>
                                                            ...
                                                            <td className="fc-day fc-fri fc-widget-content fc-past" data-date="2024-07-19">
                                                                <div>
                                                            ...
                                                            <td className="fc-day fc-sat fc-widget-content fc-past" data-date="2024-07-20">
                                                                <div>
                                                            ...
                                                            <td className="fc-day fc-sun fc-widget-content fc-past fc-last" data-date="2024-07-21">
                                                                <div>
                                                        ...
                                                        <tr className="fc-week">
                                                            <td className="fc-day fc-mon fc-widget-content fc-past fc-first" data-date="2024-07-22">
                                                                <div>
                                                            ...
                                                            <td className="fc-day fc-tue fc-widget-content fc-past" data-date="2024-07-23">
                                                                <div>
                                                            ...
                                                            <td className="fc-day fc-wed fc-widget-content fc-past" data-date="2024-07-24">
                                                                <div>
                                                            ...
                                                            <td className="fc-day fc-thu fc-widget-content fc-past" data-date="2024-07-25">
                                                                <div>
                                                            ...
                                                            <td className="fc-day fc-fri fc-widget-content fc-past" data-date="2024-07-26">
                                                                <div>
                                                            ...
                                                            <td className="fc-day fc-sat fc-widget-content fc-past" data-date="2024-07-27">
                                                                <div>
                                                            ...
                                                            <td className="fc-day fc-sun fc-widget-content fc-past fc-last" data-date="2024-07-28">
                                                                <div>
                                                        ...
                                                        <tr className="fc-week">
                                                            <td className="fc-day fc-mon fc-widget-content fc-today fc-state-highlight fc-first" data-date="2024-07-29">
                                                                <div>
                                                            ...
                                                            <td className="fc-day fc-tue fc-widget-content" data-date="2024-07-30">
                                                                <div>
                                                            ...
                                                            <td className="fc-day fc-wed fc-widget-content" data-date="2024-07-31">
                                                                <div>
                                                            ...
                                                            <td className="fc-day fc-thu fc-widget-content" data-date="2024-08-01">
                                                                <div>
                                                                    <div className="fc-day-number">1</div>
                                                                    <div className="fc-day-content">
                                                                        <div style={{ position: "relative", height: 28 }}>&nbsp;</div>
                                                            ...
                                                            <td className="fc-day fc-fri fc-widget-content" data-date="2024-08-02">
                                                                <div>
                                                                    <div className="fc-day-number">2</div>
                                                                    <div className="fc-day-content">
                                                                        <div style={{ position: "relative", height: 28 }}>&nbsp;</div>
                                                            ...
                                                            <td className="fc-day fc-sat fc-widget-content" data-date="2024-08-03">
                                                                <div>
                                                                    <div className="fc-day-number">3</div>
                                                                    <div className="fc-day-content">
                                                                        <div style={{ position: "relative", height: 28 }}>&nbsp;</div>
                                                            ...
                                                            <td className="fc-day fc-sun fc-widget-content fc-last" data-date="2024-08-04">
                                                                <div>
                                                                    <div className="fc-day-number">4</div>
                                                                    <div className="fc-day-content">
                                                                        <div style={{ position: "relative", height: 28 }}>&nbsp;</div>
                                ...
                                <form action="#">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-20">
                                            ...
                                            <div class=" position-relative">
                                                <input class="form-control radius-8 bg-base flatpickr-input" id="editstartDate" type="text" placeholder="03/12/2024, 10:30 AM" readonly="readonly" />
                                                <span class="position-absolute end-0 top-50 translate-middle-y me-12 line-height-1"><iconify-icon icon="solar:calendar-linear" class="icon text-lg"></iconify-icon></span>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-20">
                                            ...
                                            <div class=" position-relative">
                                                <input class="form-control radius-8 bg-base flatpickr-input" id="editendDate" type="text" placeholder="03/12/2024, 2:30 PM" readonly="readonly" />
                                                <span class="position-absolute end-0 top-50 translate-middle-y me-12 line-height-1"><iconify-icon icon="solar:calendar-linear" class="icon text-lg"></iconify-icon></span>
                                            </div>
                                        </div>
                                        <div class="col-12 mb-20">
