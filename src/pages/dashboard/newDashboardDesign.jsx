...
const newDashboardDesign = () => {
    return (
        <div> <div className="dashboard-main-body">
                        ...
                        <div className="card-body p-0">
                            <div className="d-flex flex-wrap align-items-center justify-content-between gap-1 mb-8">
                                <div className="d-flex align-items-center">
                                    ...
                                    <div>
                                        <span className="mb-2 fw-medium text-secondary-light text-md">New Users</span>
                                        <h6 className="fw-semibold my-1">5000</h6>
                                        <p className="text-sm mb-0">Increase by
                                            <span className="bg-success-focus px-1 rounded-2 fw-medium text-success-main text-sm">+200</span> this week
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="card-body p-0">
                            <div className="d-flex flex-wrap align-items-center justify-content-between gap-1 mb-8">
                                <div className="d-flex align-items-center">
                                    ...
                                    <div>
                                        <span className="mb-2 fw-medium text-secondary-light text-md">Total Deposit</span>
                                        <h6 className="fw-semibold my-1">15,000</h6>
                                        <p className="text-sm mb-0">Increase by
                                            <span className="bg-danger-focus px-1 rounded-2 fw-medium text-danger-main text-sm">-200</span> this week
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="card-body p-0">
                            <div className="d-flex flex-wrap align-items-center justify-content-between gap-1 mb-8">
                                <div className="d-flex align-items-center">
                                    ...
                                    <div>
                                        <span className="mb-2 fw-medium text-secondary-light text-md">Total Expense</span>
                                        <h6 className="fw-semibold my-1">15,000</h6>
                                        <p className="text-sm mb-0">Increase by
                                            <span className="bg-success-focus px-1 rounded-2 fw-medium text-success-main text-sm">+200</span> this week
                                        </p>
                        ...
                        <div className="card-body p-0">
                            <div className="d-flex flex-wrap align-items-center justify-content-between gap-1 mb-8">
                                <div className="d-flex align-items-center">
                                    ...
                                    <div>
                                        <span className="mb-2 fw-medium text-secondary-light text-md">Total Earning</span>
                                        <h6 className="fw-semibold my-1">15,000</h6>
                                        <p className="text-sm mb-0">Increase by
                                            <span className="bg-success-focus px-1 rounded-2 fw-medium text-success-main text-sm">+200</span> this week
                                        </p>
                            ...
                            <div className="mt-24 mb-24 d-flex flex-wrap">
                                <div className="me-40">
                                    ...
                                    <div className="">
                                        ...
                                        <span className="text-success-main fw-bold d-inline-flex align-items-center gap-1">10% <iconify-icon icon="iconamoon:arrow-up-2-fill" className="icon"></iconify-icon> </span>
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div className="">
                                        ...
                                        <span className="text-danger-main fw-bold d-inline-flex align-items-center gap-1">10% <iconify-icon icon="iconamoon:arrow-down-2-fill" className="icon"></iconify-icon> </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="card-body p-24">
                            ...
                            <div className="mt-24">
                                <div className="d-flex align-items-center gap-1 justify-content-between mb-44">
                                    <div>
                                        <span className="text-secondary-light fw-normal mb-12 text-xl">Daily Conversions</span>
                                        <h5 className="fw-semibold mb-0">%60</h5>
                                    </div>
                                    <div className="position-relative">
                                        <div id="semiCircleGauge"></div>

                                        <span className="w-36-px h-36-px rounded-circle bg-neutral-100 d-flex justify-content-center align-items-center position-absolute start-50 translate-middle bottom-0"><iconify-icon icon="mdi:emoji" className="text-primary-600 text-md mb-0"></iconify-icon></span>
                                    </div>
                                </div>

                                <div className="d-flex align-items-center gap-1 justify-content-between mb-44">
                                    <div>
                                        <span className="text-secondary-light fw-normal mb-12 text-xl">Visits By Day</span>
                                ...
                                <div className="d-flex align-items-center gap-1 justify-content-between">
                                    <div>
                                        <span className="text-secondary-light fw-normal mb-12 text-xl">Today Income</span>
        ...
        <!-- Most Location Start --> */}
                <div className="col-xxl-3">
                    <div className="card radius-8 border-0">
                        ...
                        <div id="world-map" className="map-sm"></div>
                ...
                <div className="col-xxl-3">
                    <div className="card h-100 radius-8 border-0">
                        <div className="card-body p-24">
                            ...
                            <div className="position-relative">
                                <span className="w-80-px h-80-px bg-base shadow text-primary-light fw-bold text-xxl d-flex justify-content-center align-items-center rounded-circle position-absolute end-0 top-0 z-1">20k</span>
                                <div id="statisticsDonutChart" className="mt-36 flex-grow-1 apexcharts-tooltip-z-none title-style circle-none"></div>
                                <span className="w-80-px h-80-px bg-base shadow text-primary-light fw-bold text-xxl d-flex justify-content-center align-items-center rounded-circle position-absolute start-0 bottom-0 z-1">50k</span>
                            </div>

                            <ul className="d-flex flex-wrap flex-column mt-64 gap-3">
                                <li className="d-flex align-items-center gap-2">
                                    <span className="w-16-px h-16-px radius-2 bg-primary-600"></span>
                                    <span className="text-secondary-light text-lg fw-normal">Total Gain:
                                        <span className="text-primary-light fw-bold text-lg">$50,000</span>
                                    </span>
                                </li>
                                <li className="d-flex align-items-center gap-2">
                                    <span className="w-16-px h-16-px radius-2 bg-yellow"></span>
                                    <span className="text-secondary-light text-lg fw-normal">Total Investment:
                                        <span className="text-primary-light fw-bold text-lg">$20,000</span>
                                    </span>
                                </li>
                            </ul>
                                ...
                                <table className="table bordered-table sm-table mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    <img src="assets/images/asset/asset-img1.png" alt="" className="flex-shrink-0 me-12 w-40-px h-40-px radius-8 me-12" />
                                                    <div className="flex-grow-1">
                                                        <h6 className="text-md mb-0 fw-normal">Gold</h6>
                                                        <span className="text-sm text-secondary-light fw-normal">Main Asset</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <h6 className="text-md mb-0 fw-normal">7500</h6>
                                                <span className="text-sm text-secondary-light fw-normal">Ounces</span>
                                            </td>
                                            <td>$7,500.00</td>
                                            <td>25 May 2024</td>
                                            <td className="text-center">
                                                <span className="bg-success-focus text-success-main px-16 py-4 radius-8 fw-medium text-sm">Completed</span>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    <img src="assets/images/asset/asset-img2.png" alt="" className="flex-shrink-0 me-12 w-40-px h-40-px radius-8 me-12" />
                                                    <div className="flex-grow-1">
                                                        <h6 className="text-md mb-0 fw-normal">Dollars</h6>
                                                        <span className="text-sm text-secondary-light fw-normal">Currency</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <h6 className="text-md mb-0 fw-normal">5,40,000</h6>
                                                <span className="text-sm text-secondary-light fw-normal">Dollars</span>
                                            </td>
                                            <td>$5,40,000.00</td>
                                            <td>25 May 2024</td>
                                            <td className="text-center">
                                                <span className="bg-warning-focus text-warning-main px-16 py-4 radius-8 fw-medium text-sm">In Progress</span>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    <img src="assets/images/asset/asset-img3.png" alt="" className="flex-shrink-0 me-12 w-40-px h-40-px radius-8 me-12" />
                                                    <div className="flex-grow-1">
                                                        <h6 className="text-md mb-0 fw-normal">Stock Market</h6>
                                                        <span className="text-sm text-secondary-light fw-normal">Product</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <h6 className="text-md mb-0 fw-normal">1500</h6>
                                                <span className="text-sm text-secondary-light fw-normal">Products</span>
                                            </td>
                                            <td>$50,000.00</td>
                                            <td>25 May 2024</td>
                                            <td className="text-center">
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    <img src="assets/images/asset/asset-img4.png" alt="" className="flex-shrink-0 me-12 w-40-px h-40-px radius-8 me-12" />
                                                    <div className="flex-grow-1">
                                                        <h6 className="text-md mb-0 fw-normal">Dimond</h6>
                                                        <span className="text-sm text-secondary-light fw-normal">Asset</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    <img src="assets/images/asset/asset-img5.png" alt="" className="flex-shrink-0 me-12 w-40-px h-40-px radius-8 me-12" />
                                                    <div className="flex-grow-1">
                                                        <h6 className="text-md mb-0 fw-normal">S&P 500</h6>
                                                        <span className="text-sm text-secondary-light fw-normal">Index</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <h6 className="text-md mb-0 fw-normal">24,000</h6>
                                                <span className="text-sm text-secondary-light fw-normal">Shares</span>
                                            </td>
                                            <td>$63,000.00</td>
                                            <td>25 May 2024</td>
                                            <td className="text-center">
                    ...
                    <div className="card h-100">
                        <div className="card-body p-24">
                            ...
                            <div className="d-flex align-items-start gap-2 mb-20">
                                <img src="assets/images/notice/board-img1.png" alt="" className="flex-shrink-0 w-40-px h-40-px me-12 radius-8 me-12" />
                                <div className="flex-grow-1">
                                    <h6 className="text-md mb-1 fw-semibold">Admin</h6>
                                    <p className="text-sm text-secondary-light fw-medium mb-1">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum is simply dummy.</p>
                                    <span className="text-sm text-secondary-light fw-normal">25 Jan 2024</span>
                                </div>
                            </div>

                            <div className="d-flex align-items-start gap-2 mb-20">
                                <img src="assets/images/notice/board-img2.png" alt="" className="flex-shrink-0 w-40-px h-40-px me-12 radius-8 me-12" />
                                <div className="flex-grow-1">
                                    <h6 className="text-md mb-1 fw-semibold">Kathryn Murphy</h6>
                                    <p className="text-sm text-secondary-light fw-medium mb-1">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                    <span className="text-sm text-secondary-light fw-normal">25 Jan 2024</span>
                                </div>
                            </div>

                            <div className="d-flex align-items-start gap-2">
                                <img src="assets/images/notice/board-img3.png" alt="" className="flex-shrink-0 w-40-px h-40-px me-12 radius-8 me-12" />
                                <div className="flex-grow-1">
                                    <h6 className="text-md mb-1 fw-semibold">Cameron Williamson</h6>
                                    <p className="text-sm text-secondary-light fw-medium mb-1">Lorem Ipsum is simply dummy text of the printing Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                    <span className="text-sm text-secondary-light fw-normal">25 Jan 2024</span>
                                </div>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div className="max-w-112 mx-auto">
                                                    <div className="w-100">
                                                        <div className="progress progress-sm rounded-pill" role="progressbar" aria-label="Success example" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                                                            <div className="progress-bar bg-red rounded-pill" style={{ width: "30%" }}></div>
                                                        </div>
                                                    </div>
                                                    <span className="mt-8 text-secondary-light text-sm fw-medium">30%</span>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div className="max-w-112 mx-auto">
                                                    <div className="w-100">
                                                        <div className="progress progress-sm rounded-pill" role="progressbar" aria-label="Success example" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                                                            <div className="progress-bar bg-warning-main rounded-pill" style={{ width: "50%" }}></div>
                                                        </div>
                                                    </div>
                                                    <span className="mt-8 text-secondary-light text-sm fw-medium">50%</span>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div className="max-w-112 mx-auto">
                                                    <div className="w-100">
                                                        <div className="progress progress-sm rounded-pill" role="progressbar" aria-label="Success example" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                                                            <div className="progress-bar bg-info-main rounded-pill" style={{ width: "60%" }}></div>
                                                        </div>
                                                    </div>
                                                    <span className="mt-8 text-secondary-light text-sm fw-medium">60%</span>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div className="max-w-112 mx-auto">
                                                    <div className="w-100">
                                                        <div className="progress progress-sm rounded-pill" role="progressbar" aria-label="Success example" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                                                            <div className="progress-bar bg-success-main rounded-pill" style={{ width: "80%" }}></div>
                                                        </div>
                                                    </div>
                                                    <span className="mt-8 text-secondary-light text-sm fw-medium">80%</span>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div className="max-w-112 mx-auto">
                                                    <div className="w-100">
                                                        <div className="progress progress-sm rounded-pill" role="progressbar" aria-label="Success example" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                                                            <div className="progress-bar bg-red rounded-pill" style={{ width: "70%" }}></div>
                                                        </div>
                                                    </div>
                                                    <span className="mt-8 text-secondary-light text-sm fw-medium">70%</span>
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
